...
$(document).on("knack-view-render.view_466", function (event, view, data) {
  ...
  function appendShiftTable(records) {
    ...
    var currentPage = 1;
    var record = Object.values(records)[0][0];
    ...
    var recordsTable = `<div class="kn-table-wrapper">
    <table class="kn-table kn-table-table is-bordered is-striped">
      ...
      <tbody>
        ...
        <tr id="5f2441103dd0c106c27183ad">
          <td
            class="field_139"
  ...
  `;
    ...
    $("#view_466 > div.view-header").append(recordsTotalsDiv + recordsTable);
  }
});
