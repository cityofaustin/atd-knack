...
//////// Working stock replenishment Checkboxes /////////

// Set scenes and views
var scene = "scene_1105";

// Items table
var itemsView = "view_2901";
...
function appendSubmitButton(buttonString, selector, handler, view, name) {
  ...
  $("#" + id).click(function () {
    handler(event, id, view, name);
  });
}

// Create replenishment transactions from selected transactions
function handleReplenishClick(event, id, view, name) {
  ...
  function getCheckedItems(view) {
    ...
    console.log(getCheckedItems(view));
    // TODO: fetch each transaction's data from API view and do inserts
}
...
// Add checkboxes to a items and invoice items tables
$(document).on("knack-view-render.view_2903", function (event, view) {
  appendSubmitButton(
    "Replenish",
